...
![image-20240409223651707](image/image-20240409223651707.png)
...
![image-20240409224308867](image/image-20240409224308867.png)
...
![image-20240409224528826](image/image-20240409224528826.png)
...
| rgb表示法      | rgb(r,g,b)    | r,g,b 表示红绿色三原色，取值：0 - 255 | 了解                     |
| rgba表示法     | rgba(r,g,b,a) | a 表示透明度，取值： 0 - 1            | 开发使用，实现透明色     |
| 十六进制表示法 | #RRGGBB       | #000000，#ffcc00。简写：#000。#fc0    | 开发使用（从设计稿复刻） |
...
2. 使用调试工具
   ...
   ![image-20240409230629589](image/image-20240409230629589.png)
...
![image-20240409230719061](image/image-20240409230719061.png)
...
![image-20240409230809147](image/image-20240409230809147.png)
